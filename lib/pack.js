    ...
    var promises = Object.entries(dicArtifacts).map(kv => {
      return new BbPromise(function (resolve, reject) {
        ...
        try {
          ...
          program.exec('dotnet lambda package -o ' + packingInfo.artifactOutput + ' --msbuild-parameters --no-build', { "cwd": packingInfo.currentWorkingDir }, function (error, stdout, stderr) {
            //console.log(stdout);
            cli.log(stdout);
